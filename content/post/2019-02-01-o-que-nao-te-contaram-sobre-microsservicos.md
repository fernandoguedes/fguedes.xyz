...
melhor que o seu", ou, "nossa, você ainda usa isso?", se referindo ao fato de eu não
...
São muitas as perguntas e as respostas podem ser negativas ou
...
Não vá para microsserviços só por ir, por **"hype"**. Definitivamente, não faça isso! Porém, como em uma
palestra que assisti e que em várias etapas o palestrante repetia: "apesar dos *cases* de sucessos da Netflix e AWS, lembre-se: você não é Netflix e nem AWS!".
...
funcionalidade, porquê afinal também temos que paralelizar a migração a entrega
de novas _features_.
...
- Se utiliza docker como ferramenta de container, recomendo o [docker-compose](https://docs.docker.com/compose/) para "orquestrar" a estrutura de serviços localmente.
